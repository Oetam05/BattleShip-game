...
class Game():
    ...
    def game_loop(self):
        ...
        while self.playing:
            ...
            self.draw_text("player "+str(self.active_player+1)+" turn", 15, self.DISPLAY_W-150, 40, self.BLACK)
            self.draw_text("remaining ships", 20, self.DISPLAY_W-150, 100, self.BLACK)
            self.draw_text("Size 1    "+str(ship_count[0]), 13, self.DISPLAY_W-150, 150, self.BLACK)
            self.draw_text("Size 2    "+str(ship_count[1]), 13, self.DISPLAY_W-150, 220, self.BLACK)
            self.draw_text("Size 3    "+str(ship_count[2]), 13, self.DISPLAY_W-150, 290, self.BLACK)
            self.draw_text("Size 4    "+str(ship_count[3]), 13, self.DISPLAY_W-150, 360, self.BLACK)
